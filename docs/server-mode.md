...
of this server, and the opt-in CORS admitting it), and
[server-packaging-plan.md](server-packaging-plan.md) (the plan for shipping this server as a
consumer app on macOS/Windows/Linux).
