...
def _format_vertex_prop(vertex: Vertex, prop: str) -> Text | Table:
    ...
    match prop:
        ...
        case "source":
            return Text(f"source={vertex.storage.location}" if is_renderable_asset_vertex(vertex) else "source=N/A")
        case "alt_text":
