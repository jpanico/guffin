...
class TestParseStandaloneVertexLink:
    """Tests for parse_standalone_vertex_link()."""
    ...
    def test_sole_reference_parses(self) -> None:
        ...
        assert parse_standalone_vertex_link(text) == VertexLink(VertexLinkKind.REFERENCE, _UID)
    ...
    def test_sole_embed_parses(self) -> None:
        ...
        assert parse_standalone_vertex_link(text) == VertexLink(VertexLinkKind.EMBED, _UID)
    ...
    def test_empty_display_parses(self) -> None:
        ...
        assert parse_standalone_vertex_link(f"[](x-guffin:vertex/{_UID})") == VertexLink(VertexLinkKind.REFERENCE, _UID)

    def test_leading_text_is_none(self) -> None:
        """A link preceded by other text is not sole."""
        assert parse_standalone_vertex_link(f"see [display](x-guffin:vertex/{_UID})") is None

    def test_trailing_text_is_none(self) -> None:
        """A link followed by other text is not sole."""
        assert parse_standalone_vertex_link(f"[display](x-guffin:vertex/{_UID}) indeed") is None
